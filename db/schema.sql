-- Clinical Trial Participant Reminder System — Database Schema
...
CREATE INDEX idx_visits_study_id ON visits(study_id);
...
CREATE INDEX idx_calculated_events_participant_id ON calculated_study_events(participant_id);
...
CREATE INDEX idx_reminder_rules_active ON reminder_rules(active);
...
CREATE INDEX idx_reminder_jobs_participant_id ON reminder_jobs(participant_id);
CREATE INDEX idx_reminder_jobs_status ON reminder_jobs(status);
CREATE INDEX idx_reminder_jobs_scheduled_send_datetime ON reminder_jobs(scheduled_send_datetime);
CREATE INDEX idx_reminder_jobs_visit_id ON reminder_jobs(visit_id);
...
CREATE INDEX idx_audit_logs_participant_id ON audit_logs(participant_id);
